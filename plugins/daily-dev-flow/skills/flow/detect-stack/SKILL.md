...
0. **Aucun manifeste dans le repo** : il n'y a rien à détecter — ne devine pas une stack à
   partir d'un dossier vide. C'est le cas greenfield, traité en amont : la stack y est arbitrée
   avec l'utilisateur par `/new-project` et écrite dans le `CLAUDE.md` du projet, où `/ticket`
